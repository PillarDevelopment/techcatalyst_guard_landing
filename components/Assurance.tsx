...
// Сейчас отражено: реестр отеч. ПО / ФСТЭК — заявка в процессе.
const pillars = [
  {
    title: "Детектирование, а не «чёрный ящик»",
    items: [
      "Точность и полноту измеряем на ваших репозиториях, метрики воспроизводимы",
      "Пороги и категории настраиваются, есть правила подавления",
      "Контрольный отчёт по итогам пилота — с цифрами, а не обещаниями",
    ],
  },
  {
    title: "Данные и соответствие (РФ)",
    items: [
      "Данные не покидают ваш контур и российскую юрисдикцию — это закрывает локализацию по 152-ФЗ",
  ...
  },
  {
    ...
    items: [
      "Решение работает в вашем контуре без обращений к нам",
      "Не перестанет работать, если мы будем недоступны",
      "Депонирование исходного кода по запросу: исходники хранятся у независимого агента",
    ],
  },
];
    ...
    <section id="assurance" className="py-[92px] max-sm:py-16">
      <Wrap>
        <Reveal>
          ...
          <H2>На ключевые вопросы проверки мы отвечаем заранее</H2>
          <Lead>
