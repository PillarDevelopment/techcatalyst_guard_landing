...
const includes = [
  ...
  "Контрольная оценка качества детектирования на ваших репозиториях",
  "Критерии приёмки и границы гарантий фиксируем письменно до старта",
  "Архитектурная схема, требования по ресурсам и условия развёртывания",
  "Без зависимости от поставщика: контур, данные и агенты остаются под вашим контролем",
];
