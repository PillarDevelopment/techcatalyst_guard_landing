...
// forked from design-sync lib/dts.mjs — H2 heading primitive matches the ALL_CAPS constant filter; allow H1-H6
export const isComponentName = (n) => !n.endsWith('Props') && (/^H[1-6]$/.test(n) || !/^[A-Z][A-Z0-9_]+$/.test(n))
